...
class DeepQNetwork(object):
    def __init__(self, lr, n_actions, name, fc1_dims=1024,
        ...
        self.saver = tf.train.Saver()  # save params
        self.checkpoint_file = os.path.join(chkpt_dir,'Breakout-v0.ckpt')
    ...
    def load_checkpoint(self):
        ...
        self.saver.restore(self.sess, self.checkpoint_file) # load by restore function
...
class Agent(object):
    ...
    def store_transition(self, state, action, reward, state_, terminal):
        ...
        self.terminal_memory[index] = 1 - terminal  # terminal
        self.mem_cntr += 1
    ...
    def learn(self):
        ...
        if self.mem_cntr > 25000: #25000  #200000:
